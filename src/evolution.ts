...
export interface FailureEvent { id: string; category: "unknown" | "contradiction" | "provider" | "verification" | "duplicate" | "timeout" | "policy" | "other"; summary: string; occurredAt: string; transactionId?: string; }
